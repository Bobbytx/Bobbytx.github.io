  ...
  return (
    <div className="grid-container">
      ...
      <div className="experience-content">
        <p>
          I am a Full-Stack Software Engineer with a background in operations, logistics, and supply chain management.
